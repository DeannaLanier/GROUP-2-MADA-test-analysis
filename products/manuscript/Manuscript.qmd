...
```{r}
#| label: fig-boxplot
#| fig-cap: "Boxplot of Height and Hair Color"
#| echo: FALSE
knitr::include_graphics(here("results","Height_Hair_Boxplot.png"))
```
...
#| fig-cap: "Scatter plot of Weight and Forehead Size"
#| echo: FALSE
knitr::include_graphics(here("results","Weight_Forehead_Scatter.png"))
```
